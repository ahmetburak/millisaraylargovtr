    ...
    <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<?PHP echo $path; ?>e-bilet/" >E-Bilet</a></li>
                <li><a href="<?PHP echo $path; ?>rezervasyon/" >Rezervasyon</a></li>
                ...
                <li><a href="<?PHP echo $path; ?>ihaleler/" class="smenu mresponsive">İhale ve Mevzuat</a></li>
                <li><a href="<?PHP echo $path; ?>iletisim" class="smenu mresponsive">İletişim</a></li>
